        ...
        <div>
                ...
                <div className="grid-wrapper-4x1">
                    <div>
                        ...
                        <h5 className="usp">Top-notch Product Recommendations</h5>
                        <p className="usp-1">Our team of tech experts only include products that they would happily spend their 
                            money on. True tech geeks at heart, this causes more (respectful) arguments than 
                            we’d like to admit.</p>
                    </div>
                    <div>
                        <img className="tick" src={Tick}/>
                        <h5 className="usp">Compare and Contrast With Ease</h5>
                        <p className="usp-1">Our mums all tell us we’re unique, but our comparison tool is what really makes us 
                    ...
                    <div>
                        <img className="tick" src={Tick}/>
                        <h5 className="usp"> Female-Founded and Fabulous</h5>
                        <p className="usp-1">Opt-in is led by an amazing CEO (who happens to be a woman) and as a team, we are 
                    ...
                    <div>
                        <img className="tick" src={Tick}/>
                        <h5 className="usp">We Give a S#!+</h5>
                        <p className="usp-1" >Our mission is to help you enrich your life with technology that actually delivers, 
