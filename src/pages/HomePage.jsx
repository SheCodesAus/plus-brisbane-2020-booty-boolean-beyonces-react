            ...
            <div>
                <div className="pink-tick-bg">
                    <div className="white-text-box">
                        <div>
                            <h2 className="WelcomeHeader">Welcome to Opt-In</h2>
                            <p className="WelcomeText-1">So… you need a new phone? Laptop? A million dollars?</p>

                            <p className="WelcomeText-2">Well, we can’t really help you with the latter, but we can help 
                        ...
                        <div> <img className="newtick" src={ imagetick } ></img>
                        </div>
